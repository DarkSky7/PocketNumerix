/*
    from:  http://textelectric.net/btree.html
...
// size limit for the array in a vector object.  best performance at 800 bytes.
...
//------------------------------------------------------------------------ 
int Node::delete_all_subtrees( void )
...
//------------------------------------------------------------------------ 
int Node::index_has_subtree( void )
...
//------------------------------------------------------------------------ 
Elem& Node::smallest_key_in_subtree( void )
{
    if ( is_leaf() )
        return  m_vector[1];
    else
