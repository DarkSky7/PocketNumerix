...
//	long			evalDate;			// compressed date of option evaluation
	...
	// the following is used in the HedgeExplorer (definite links to the database)
typedef struct
...
//---------------------------------------------------------------------------
#endif		// !defined(AFX_OneStk3OptStrategy_H__BF98493C_AE1F_4C52_95B7_A4A03AA87931C4F2__INCLUDED_)
