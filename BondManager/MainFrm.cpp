...
//	theApp.SetNID_HWND( GetSafeHwnd() );
	...
	dlg.rateSens.deltaLow = -dlg.topLeft.x;					// flip it positive
	dlg.rateSens.deltaHigh = dlg.bottomRight.x;
...
#endif
	// XXX there's a problem with deconstruction - we're doing it twice
