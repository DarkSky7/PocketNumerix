...
#if ( ! PPC02_TARGET )			// ( PPC03_TARGET  ||  WM5_TARGET )
...
//	virtual void Dump( CDumpContext& dc ) const;		// won't compile in VS8 given current project settings
#endif

protected:  // control bar embedded members
#if ( PPC02_TARGET )
	CCeCommandBar	m_wndCommandBar;
#else					// ( PPC03_TARGET  ||  WM5_TARGET )
...
//	afx_msg BOOL OnIconNotify();										// ON_COMMAND - never gets called
	...
	afx_msg LRESULT OnBondManagerAlreadyRunning( WPARAM, LPARAM );
	//}}AFX_MSG
