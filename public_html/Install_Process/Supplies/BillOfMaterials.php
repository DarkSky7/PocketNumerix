...
{	# ?os=%s?dv=%d?em=%s?in=%s?dt=%4d-%02d-%02d?ln=%s?fn=%s
	$decryptParams = "?os=5.0.13?dv=104892745?em=mlandis001@comcast.net?fn=Mike?ln=Landis?in=1?dt=2007-02-21";
}
else
...
mysql_query( $query ) or die( "bom_requests: I failed: " .  mysql_error() );
#-------------------------------------------------------------------------------+
